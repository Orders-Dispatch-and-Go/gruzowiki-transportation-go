...
type GetCargoRequestIDAndRouteRow struct {
	ID      pgtype.UUID
	RouteID pgtype.UUID
}

func (q *Queries) GetCargoRequestIDAndRoute(ctx context.Context, id pgtype.UUID) (GetCargoRequestIDAndRouteRow, error) {
	row := q.db.QueryRow(ctx, getCargoRequestIDAndRoute, id)
	var i GetCargoRequestIDAndRouteRow
	err := row.Scan(&i.ID, &i.RouteID)
	return i, err
}
...
type SetTripIDForCargoRequestParams struct {
	ID     pgtype.UUID
	TripID pgtype.UUID
}

func (q *Queries) SetTripIDForCargoRequest(ctx context.Context, arg SetTripIDForCargoRequestParams) error {
	_, err := q.db.Exec(ctx, setTripIDForCargoRequest, arg.ID, arg.TripID)
	return err
}
...
type UpdateCargoRequestReceiveCodeParams struct {
	ID          pgtype.UUID
	ReceiveCode pgtype.Int4
}

func (q *Queries) UpdateCargoRequestReceiveCode(ctx context.Context, arg UpdateCargoRequestReceiveCodeParams) error {
	_, err := q.db.Exec(ctx, updateCargoRequestReceiveCode, arg.ID, arg.ReceiveCode)
	return err
}

const updateCargoRequestRoute = `-- name: UpdateCargoRequestRoute :exec
UPDATE cargo_requests 
SET route_id = $2 
WHERE id = $1
`

type UpdateCargoRequestRouteParams struct {
	ID      pgtype.UUID
	RouteID pgtype.UUID
}

func (q *Queries) UpdateCargoRequestRoute(ctx context.Context, arg UpdateCargoRequestRouteParams) error {
	_, err := q.db.Exec(ctx, updateCargoRequestRoute, arg.ID, arg.RouteID)
	return err
}
...
const updateTripRoute = `-- name: UpdateTripRoute :exec
UPDATE trips 
SET route_id = $2 
WHERE id = $1
`

type UpdateTripRouteParams struct {
	ID      pgtype.UUID
	RouteID pgtype.UUID
}

func (q *Queries) UpdateTripRoute(ctx context.Context, arg UpdateTripRouteParams) error {
	_, err := q.db.Exec(ctx, updateTripRoute, arg.ID, arg.RouteID)
	return err
}
